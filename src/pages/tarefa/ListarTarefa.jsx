...
function createData(
  ...
  return { idTarefa, tituloTarefa, descricaoTarefa, inicioTarefa, fimTarefa, recursoTarefa, statusTarefa };
}

//Definição do array contendo os dados iniciais da listagem de tarefas
const initialRows = [
  createData(1, 'Tarefa 1', 'Descrição da Tarefa 1', '2022-01-01', '2022-01-02', 'Recurso 1', 'Concluída'),
  createData(2, 'Tarefa 2', 'Descrição da Tarefa 2', '2022-01-03', '2022-01-04', 'Recurso 2', 'Em Andamento'),
  createData(3, 'Tarefa 3', 'Descrição da Tarefa 3', '2022-01-04', '2022-01-05', 'Recurso 1', 'Em Andamento'),
  createData(4, 'Tarefa 4', 'Descrição da Tarefa 4', '2022-01-05', '2022-01-06', 'Recurso 2', 'Em Andamento'),
  createData(5, 'Tarefa 5', 'Descrição da Tarefa 5', '2022-01-06', '2022-01-07', 'Recurso 3', 'Em Andamento'),
  createData(6, 'Tarefa 6', 'Descrição da Tarefa 6', '2022-01-07', '2022-01-08', 'Recurso 3', 'Aguardando'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardActions>
            <Button size="medium" variant="contained" onClick={handleOpen}>Criar Tarefa</Button>
            <Button size="medium" variant="outlined">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
